...
const resolvers = {
    ...
    Mutation: {
        async postPhoto(parent, args, {db, currentUser, pubsub}){         
           ...
           * It is like Node.js EventEmitter.
           * You can use it to publish events and send data to every haandler that has subscribed to an event.
           */
    ...
    Subscription: {
      newPhoto: {
        subscribe: (parent, args, {pubsub}) => 
          pubsub.asyncIterator('photo-added') //Subscribed to the 'photo-added' event
      },
      newUser: {
        subscribe: (parent, args, {pubsub}) => 
          pubsub.asyncIterator('user-added') //Subscribed to the 'user-added' event
      }
    },
